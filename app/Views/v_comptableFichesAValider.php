    ...
    <table class="listeLegere">
        ...
        <?php    
            foreach($lesFiches as $uneFiche) 
            {
                ...
                if ($uneFiche['id'] == 'CL') {
                    $modLink = anchor('comptable/modMaFiche/'.$uneFiche['mois'], 'Refuser', 'title="Modifier la fiche"');
                    $signeLink = anchor('comptable/validerLaFiche/'.$uneFiche['mois'], 'Valider', 'title="Signer la fiche"  onclick="return confirm(\'Voulez-vous vraiment valider cette fiche ?\');"');
                }
